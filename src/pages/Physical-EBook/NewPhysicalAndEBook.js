...
const NewPhysicalAndEBook = () => {
    ...
    function handleInputEBookPrice(value) {
        setEBookPrice(value);
    }
    ...
    const handleCreate = async () => {
      ...
      const response = await fetch("https://localhost:44301/api/books/physicalbook-ebook", {
        method: "POST",
      ...
      try {
        ...
        if (response != null) {
          ...
          navigate("/dashboard/physical-ebook");
        } else {
          alert("Create failed!");
        }
      } catch (error) {
    ...
    return (
      ...
      >
        ...
        <Row gutter={8}>
          ...
          <Col span={8}>
            <Form.Item label="EBook Price">
              <Form.Item
                name="eBookPrice"
                rules={[
                  {
                    required: true,
                    message: "Please type your e-book price",
                  },
                ]}
                noStyle
              >
                <InputNumber
                  min={1}
                  onChange={handleInputEBookPrice}
                  value={eBookPrice}
                />
              </Form.Item>
            </Form.Item>
...
export default NewPhysicalAndEBook;